...
get_filename_component(_filename "/home/zjh/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/image_common/polled_camera/srv/GetPolledImage.srv" NAME_WE)
add_custom_target(_polled_camera_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "polled_camera" "/home/zjh/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/image_common/polled_camera/srv/GetPolledImage.srv" "sensor_msgs/RegionOfInterest"
)
...
_generate_srv_cpp(polled_camera
  "/home/zjh/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/image_common/polled_camera/srv/GetPolledImage.srv"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/polled_camera)
  install(CODE "execute_process(COMMAND \"/home/zjh/anaconda3/envs/lab/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/polled_camera\")")
  # install generated code
  install(
