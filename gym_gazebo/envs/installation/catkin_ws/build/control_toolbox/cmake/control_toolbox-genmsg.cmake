...
get_filename_component(_filename "/home/zjh/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/control_toolbox/srv/SetPidGains.srv" NAME_WE)
add_custom_target(_control_toolbox_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "control_toolbox" "/home/zjh/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/control_toolbox/srv/SetPidGains.srv" ""
)
...
_generate_srv_cpp(control_toolbox
  "/home/zjh/gym-gazebo/gym_gazebo/envs/installation/catkin_ws/src/control_toolbox/srv/SetPidGains.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/control_toolbox)
  install(CODE "execute_process(COMMAND \"/home/zjh/anaconda3/envs/lab/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/control_toolbox\")")
  # install generated code
  install(
